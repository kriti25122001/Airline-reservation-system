<?php
  ...
  if( $_SERVER["REQUEST_METHOD"] == "POST"){
    $que = "insert into booking values ('$user','$flight', '$class');";

    if($conn->query($que)==true){
      echo "<script>alert('Your ticket has been booked and will be sent by mail')</script>";
    } else {
      echo "<script>alert('Something went wrong at our end. Please be patient while we fix the issue')</script>";
    }
    $que = "";
    $conn->close();
  }
